...
# Fit the model
# global.quadratic.nb <- glmer.nb(mod.formula, data=good.data,
#                                control=glmerControl(optCtrl=list(maxfun=2e4), 
#                                                     optimizer = c("Nelder_Mead", "bobyqa")))
# plot(predict(global.quadratic.pois, type = "response",re.form=NA), 
#      predict(global.quadratic.nb, type = "response",re.form=NA))
### See above for negative binomial version. Resul
